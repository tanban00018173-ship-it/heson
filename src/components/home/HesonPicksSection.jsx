...
function PickCard({ profile, avgRating, reviewCount, onClick }) {
  return (
    ...
    >
      <div className="relative h-40 bg-gradient-to-br from-stone-100 to-stone-200 overflow-hidden flex items-center justify-center flex-shrink-0 rounded-t-2xl">
