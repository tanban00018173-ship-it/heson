  ...
  return (
    ...
    >
      ...
      <div className="p-3 flex flex-col items-center text-center">
        {providerPhoto ? (
          <img src={providerPhoto} alt="" className="w-12 h-12 rounded-full object-cover border border-stone-100 mb-2" />
        ) : (
          <div className="w-12 h-12 rounded-full bg-stone-200 flex items-center justify-center mb-2">
            <span className="text-lg">🧹</span>
          </div>
        )}
        {item.price && <p className="text-sm font-bold text-stone-900 mb-1.5">NT$ {item.price.toLocaleString()} 起</p>}
