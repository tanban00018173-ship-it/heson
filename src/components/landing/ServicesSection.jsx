            ...
            {categories.map((cat, i) => (
              ...
              >
                <Link to={createPageUrl("BookingForm")}>
                  <div className="bg-white rounded-2xl p-5 text-center hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border border-stone-100 relative">
                    {cat.hot && (
        ...
        <div className="container mx-auto px-6 lg:px-12">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {hotServices.map((service, i) => (
              ...
              >
                <Link to={createPageUrl("BookingForm")}>
                  <div className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-stone-100">
